  ...
  return (
    <main className="landing-page">
      <nav className="landing-nav" aria-label="Primary">
        ...
        <button className="landing-nav-cta" onClick={onEnter}>Sign in with wallet <ArrowIcon /></button>
      </nav>
      ...
      <section className="landing-hero">
        <div className="landing-hero-copy">
          ...
          <div className="landing-actions"><button className="landing-primary" onClick={onEnter}>Sign in with wallet <ArrowIcon /></button><a className="landing-secondary" href="#architecture">Explore the model <span>↓</span></a></div>
      ...
      <section className="landing-final"><div><span className="landing-kicker">YOUR PORTFOLIO STARTS WITH YOUR WALLET</span><h2>Sign in. See your holdings.</h2><p>No separate account to create. Your Solana wallet is the account.</p></div><button className="landing-final-button" onClick={onEnter}>Sign in with wallet <ArrowIcon /></button></section>
      <footer className="landing-footer"><div className="landing-brand"><span className="landing-brand-mark">SP</span><span>StockPassport</span></div><span>Solana Devnet demo · Mainnet reference data · Synthetic assets</span><button onClick={onEnter}>Sign in <ArrowIcon /></button></footer>
    </main>
  );
}
